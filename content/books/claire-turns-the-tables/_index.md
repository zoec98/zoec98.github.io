...
description: |
  ...
  Slow Undressing, Restraints, Teasing, Tickling, Bondage, Female-on-Top, Orgasm.

  Claire turns the tables on Ethan, and he revels in it when she takes the lead
...
F/m, Consensual, Domestic Setting, Playful Femdom, Light D/s, Power Play, Corsetry,
Slow Undressing, Restraints, Teasing, Tickling, Bondage, Female-on-Top, Orgasm.
{{% /details %}}

{{% details title="**Claire turns the tables on Ethan, and he revels in it when she takes the lead.**" %}}
